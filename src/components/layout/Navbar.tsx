...
export default function Navbar() {
  ...
  const tabs = isLoggedIn ? DASHBOARD_TABS : PUBLIC_TABS;
            ...
            <div className="absolute top-[calc(100%+8px)] right-0 w-56 card shadow-lg overflow-hidden flex flex-col z-50">
              <div className="px-4 py-3 border-b border-black/8 dark:border-white/8">
                {isLoggedIn ? (
                  ...
                  <>
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">browsing as guest</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">no sign-in needed to view content</p>
                  </>
                )}
              </div>
