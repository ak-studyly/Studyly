    ...
    <div className="max-w-md flex flex-col gap-6">
      ...
      <div className="card p-5">
        ...
        <div className="text-sm text-gray-500 dark:text-gray-400 space-y-1.5">
          ...
          <div className="flex justify-between">
            <span>role</span>
            <span className="text-gray-900 dark:text-gray-100 capitalize">{profile?.role ?? "—"}</span>
          </div>
          <div className="flex justify-between">
            <span>section</span>
            <span className="text-gray-900 dark:text-gray-100">Section {profile?.section}</span>
          </div>
        </div>
      </div>
