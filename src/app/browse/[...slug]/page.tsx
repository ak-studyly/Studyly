  ...
  if (done) {
    return (
      <div className="max-w-md pt-16 flex flex-col items-center gap-3 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">It will appear in the upcoming dates panel for Section {profile?.section}.</p>
  ...
  return (
    <div className="max-w-md flex flex-col gap-6">
      ...
      <form onSubmit={handleSubmit} className="card p-5 flex flex-col gap-4">
        ...
        <div>
          <label className="text-xs font-medium text-gray-500 dark:text-gray-400 block mb-1.5">description <span className="text-gray-300 dark:text-gray-700">(optional)</span></label>
